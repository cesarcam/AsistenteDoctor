...
Item{
    ...
    ListModel {
        id: motivoModel
        ListElement {
            Motivo: "Lession en pie izquierdo"
            fecha: "02/05/2016"
        }
        ListElement {
            Motivo: "Lession dedo gordo"
            fecha: "02/01/2016"
        }
        ListElement {
            Motivo: "Lession en pie izquierdo"
    ...
    Row {
        ...
        anchors.top: hospitalizacionesTabla.bottom
        anchors.topMargin: 10

        FlatInput {
            id: descripcionTrauma1
            height: 35
            placeholderText: "ingresa el motivo"
        }
        FlatInput {
            id: fechaTrauma
            height: 35
            ...
            anchors.leftMargin: 10
            placeholderText: "ingresa fecha del motivo"
